...
class CounsellorTimeWidget extends StatefulWidget {
  const CounsellorTimeWidget({Key? key}) : super(key: key);

  @override
  _CounsellorTimeWidgetState createState() => _CounsellorTimeWidgetState();
}

class _CounsellorTimeWidgetState extends State<CounsellorTimeWidget> {
