...
class Physio_HomePage extends StatefulWidget {
  const Physio_HomePage({Key? key}) : super(key: key);

  @override
  _Physio_HomePageState createState() => _Physio_HomePageState();
}

class _Physio_HomePageState extends State<Physio_HomePage> {
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    Navigator.push(
                      ...
                      CupertinoPageRoute(
                          builder: (context) =>
                              PhysioProfileview(pid.text.trim())),
                    );
                  },
                  child: Padding(
                    padding: const EdgeInsets.only(left: 30.0, right: 30.0),
