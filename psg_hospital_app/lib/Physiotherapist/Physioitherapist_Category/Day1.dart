...
class _Day1State extends State<Day1> {
  ...
  List<String> UpperLimb = ["Session - 1", "Session - 2"];
  List<String> LowerLimb = ["Session - 1", "Session - 2"];
                      ...
                      children: <Widget>[
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            TextField(
                                onChanged: (value) {
                                  Physiotherapist.Day1[2][0] = value.toString();
                                },
                            ...
                            SizedBox(
                              ...
                              child: Wrap(
                                children: [
                                  CheckboxListTile(
                                    ...
                                    onChanged: (newValue) {
                                      setState(() {
                                        ...
                                        Physiotherapist.Day1[4][0] =
                                            homeexercise.toString();
                                      });
                                    },
                                  ...
                                  CheckboxListTile(
                                    title: const Text("Activity Guidelines"),
                                    value: activity,
                                    onChanged: (newValue) {
                                      setState(() {
                                        if (activity) {
                            ...
                            DropdownButtonFormField(
                              ...
                              onChanged: (val) {
                                Physiotherapist.Day1[7][0] = val.toString();
                                setState(() {});
                              },
                            ),
                            const SizedBox(
                            ...
                            TextFieldWidget_M(
                              ...
                              index: 11,
                              Num: false,
                              hintText: 'DIAPHRAGMATIC BREATHING EXERCISES:',
                              obscureText: false,
                              prefixIconData: Icons.arrow_right,
                              suffixIconData: Icons.verified_user,
                              catkey: 'DAY1',
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                children: <Widget>[
                                  Flexible(
                                      child: Text(
                                    "CIRCULATORY EXERCISES - LYING ON THE BED",
                                    style: GoogleFonts.lato(
                                      color: const Color(0xff4A64FE),
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold,
                        ...
                        GestureDetector(
                          onTap: () {
                            ///////////// COPYCODE ////////////////
                            Physiotherapist.Day1[0][0] =
                                CurrentPatientInfo.PatientID;

                            Map map = Physiotherapist.Day1.asMap();
                            ...
                            upload.UploadDay1(blocksMapOfIntToString)
                                .then((value) {
