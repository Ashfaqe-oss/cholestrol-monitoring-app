...
import 'Data_View_Update/View_Add_Delete.dart';

class DietitianProfileview extends StatefulWidget {
  final String PatientID;
  DietitianProfileview(this.PatientID);
  @override
  _DietitianProfileviewState createState() => _DietitianProfileviewState();
}

class _DietitianProfileviewState extends State<DietitianProfileview> {
  bool load = true;
  void loaddata() async {
    DocView.ProfileInfo = [];
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        CupertinoPageRoute(
                            builder: (context) => DietitianAddDeleteEdit()),
                      );
                    },
                    child: Padding(
