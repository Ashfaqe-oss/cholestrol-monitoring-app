...
class DietitianDateWidget extends StatefulWidget {
  final String heading;
  final int index;
  final String Colval;
  final String tag;

  DietitianDateWidget(this.heading, this.index, this.Colval, this.tag);
  @override
  _DietitianDateWidgetState createState() => _DietitianDateWidgetState();
}

class _DietitianDateWidgetState extends State<DietitianDateWidget> {
